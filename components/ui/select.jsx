...
function SelectTrigger({
  ...
  return (
    (<SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex h-[48px] w-full items-center justify-between rounded-md border border-white/10 bg-background px-4 py-5 text-base text-white/60 placeholder:text-white/10 focus:border-luke outline-none",
        className
      )}
      {...props}>
      {children}
